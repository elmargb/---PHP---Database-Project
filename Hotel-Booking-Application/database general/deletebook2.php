...
$code = $_GET['coursecode'];//coursecode pulldown menu
...
<form action = "deletebook3.php" method = "post" id = "bookingupdate" class="course">
    <fieldset>
        <div class ="fieldarea">
        ...
        <div class ="fieldarea">
         ...
         <input type="text" name="datetime" id="title" size="35" disabled = "disabled" value = "<?php echo $title; ?>" />
        </div>
        <div class ="fieldarea">
          <label for="leader" class="fixedwidth">Occupants</label>
         <input type="text" name="occupants" id="leader" size="20" disabled = "disabled" value = "<?php echo $leader; ?>" />
          </div>
        <div class ="fieldarea">
          <label for="years" class="fixedwidth">Length of stay</label>
	 <input type="text" name="length" id="years" size="20" disabled = "disabled" value = "<?php echo $years; ?>" />
	</select>
        </div>
         <div class ="fieldarea">
